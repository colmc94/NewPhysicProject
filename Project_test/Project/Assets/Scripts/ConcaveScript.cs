...
public class ConcaveScript : MonoBehaviour {
    ...
    public Text test,uSliderText,vSliderText;
	...
	void Start () {
        ...
        vPos = new Vector3(vBeam.transform.position.x, vBeam.transform.position.y, vBeam.transform.position.z);
        screenPos = new Vector3(screen.transform.position.x, screen.transform.position.y, screen.transform.position.z);
    }
	...
	void Update () {
        ...
        test.text = "u = " + u.ToString("f1")+ " v = " + v+ " real v = " + correctValue.ToString("f2")+ " a = " + image.color.a*255;
    }
    public void uChange()
    {
